                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <input type="text" 
                               name="prenom" 
                               id="edit_prenom"
                               x-model="selectedContact?.prenom"
                               class="mt-1 block w-full h-12 rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 text-base">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" 
                               ...
                               id="edit_telephone" 
                               required
                               x-model="selectedContact?.telephone"
                               class="mt-1 block w-full h-12 rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 text-base">
                    </div>

                    <div>
                        <label for="edit_entreprise" class="block text-sm font-medium text-gray-700">Entreprise</label>
                        <input type="text" 
                               name="entreprise" 
                               id="edit_entreprise"
                               x-model="selectedContact?.entreprise"
                               class="mt-1 block w-full h-12 rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 text-base">
                    </div>
                    ...
                    <div>
                        ...
                        <textarea name="adresse" 
                                  id="edit_adresse"
                                  x-model="selectedContact?.adresse"
