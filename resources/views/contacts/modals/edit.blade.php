<div x-show="showEditModal" 
    ...
    <div class="relative bg-white dark:bg-zinc-900 w-full max-w-lg rounded-2xl shadow-2xl"
        ...
        <template x-if="selectedContact">
            <form :action="`{{ url('/contacts') }}/${selectedContact.id}`" method="POST">
                @csrf
                @method('PUT')
                ...
                <div class="p-6 border-b border-zinc-200 dark:border-zinc-700">
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            <h3 class="text-xl font-bold text-zinc-900 dark:text-zinc-100">Modifier le contact</h3>
                            <p class="text-sm text-zinc-500 dark:text-zinc-400" x-text="selectedContact.email"></p>
                        </div>
                    </div>
                </div>
                ...
                <div class="p-6 space-y-4 max-h-[60vh] overflow-y-auto">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <input type="text" 
                                   name="entreprise" 
                                   :value="selectedContact.entreprise"
                                   list="entreprises-edit-list"
                                   class="w-full pl-11 pr-4 py-3 bg-zinc-100 dark:bg-zinc-800 border-0 rounded-xl focus:ring-2 focus:ring-indigo-500 text-zinc-900 dark:text-zinc-100">
                            <svg class="absolute left-4 top-3.5 size-5 text-zinc-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" />
                            </svg>
                            <datalist id="entreprises-edit-list">
                    ...
                    <div>
                        ...
                        <textarea name="adresse" 
                                  rows="2"
                                  x-text="selectedContact.adresse"
