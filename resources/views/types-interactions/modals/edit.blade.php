<div x-show="showEditModal" 
    ...
    <div class="relative bg-white w-full max-w-2xl rounded-xl shadow-2xl"
        ...
        <form x-bind:action="'/types-interactions/' + selectedType.id" method="POST">
            @csrf
            @method('PUT')
            <div class="p-6">
                <h3 class="text-xl font-semibold text-gray-900 mb-6">
                    Modifier le type d'interaction
                </h3>
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <textarea name="description" 
                                  id="edit_description"
                                  x-model="selectedType.description"
