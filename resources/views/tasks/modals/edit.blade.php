<div x-show="showEditModal" x-cloak
    ...
    <div class="relative bg-white w-full max-w-2xl rounded-xl shadow-2xl" @click.away="showEditModal = false">
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <textarea name="description" id="edit_description" rows="3"
                                  ...
                                  class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 text-base"></textarea>
                    </div>

                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            <label for="edit_due_date" class="block text-sm font-medium text-gray-700">Date d'échéance</label>
                        ...
                        <div>
                            <label for="edit_priority" class="block text-sm font-medium text-gray-700">Priorité</label>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            <label for="edit_user_id" class="block text-sm font-medium text-gray-700">Assigner à</label>
                            <select name="user_id" id="edit_user_id" required
                                    x-model="selectedTask.user_id"
                                    class="mt-1 block w-full h-12 rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 text-base">
                    ...
                    <div>
                        <label for="edit_contact_id" class="block text-sm font-medium text-gray-700">Lier à un contact (Optionnel)</label>
                        <select name="contact_id" id="edit_contact_id"
                                x-model="selectedTask.contact_id"
                                class="mt-1 block w-full h-12 rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 text-base">
