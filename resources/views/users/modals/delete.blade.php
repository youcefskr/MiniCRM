        ...
        <template x-if="selectedUser">
            <div>
                ...
                <div class="p-6 text-center">
                    ...
                    <h3 class="text-xl font-bold text-zinc-900 dark:text-zinc-100 mb-2">Supprimer l'utilisateur</h3>
                    <p class="text-sm text-zinc-500 dark:text-zinc-400">
                        Êtes-vous sûr de vouloir supprimer l'utilisateur 
                        <span class="font-semibold text-zinc-900 dark:text-zinc-100" x-text="selectedUser.name"></span> ?
                    </p>
                    ...
                    <div class="mt-4 p-4 bg-zinc-50 dark:bg-zinc-800 rounded-xl flex items-center gap-4">
                        ...
                        <div class="text-left">
                            <div class="font-semibold text-zinc-900 dark:text-zinc-100" x-text="selectedUser.name"></div>
                            <div class="text-sm text-zinc-500" x-text="selectedUser.email"></div>
                        </div>
                    </div>
                    
                    <p class="mt-4 text-xs text-zinc-400">Cette action est irréversible.</p>
                </div>
                ...
                <div class="p-6 border-t border-zinc-200 dark:border-zinc-700 flex gap-3">
                    ...
                    <form :action="`{{ url('/admin/users') }}/${selectedUser.id}`" method="POST" class="flex-1">
                        @csrf
                        @method('DELETE')
                        <button type="submit"
